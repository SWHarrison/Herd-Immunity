...
class Simulation(object):
    ...
    def __init__(self, population_size, vacc_percentage, virus_name,
        ...
        self.infection = Virus(virus_name, mortality_rate, basic_repro_num)
        ...
        # list.
        self.newly_infected = []
        self.living_population = self._create_population(initial_infected,vacc_percentage)
    ...
    def _create_population(self, initial_infected,vacc_percentage):
        ...
        while len(population) != self.population_size:
            if self.current_infected !=  initial_infected:
                ...
                # new infected person!
                person_to_add = Person(False,self.infection)
                #print(str(person_to_add._id) + person_to_add.infection.name)
                population.append(person_to_add)
                ...
                if(vacc_chance < vacc_percentage):
                    person_to_add = Person(True, None)
                    population.append(person_to_add)
                else:
                    person_to_add = Person(False, None)
                    population.append(person_to_add)
    ...
    def run(self):
        ...
        # to rebind should_continue to another call of self._simulation_should_continue()!
            ...
            self.logger.log_time_step(time_step_counter, self.total_dead, self.current_infected)
            ...
            for person in self.living_population:
                if(person.infection != None):
                    for x in range(0,100):
                        index = random.randint(0,len(self.living_population)-1)
                        if(index >= len(self.living_population)):
                            print(index)
                            print(len(self.living_population))
                        self.interaction(person, self.living_population[index])
    ...
    def interaction(self, person, random_person):
        ...
        if(infect_chance < person.infection.rep_rate):
    ...
    def _infect_newly_infected(self):
        '''This method also updates the living population'''
        ...
        for id in self.newly_infected:
            self.population[id].infection = self.infection
        ...
        for person in self.population:
            if(person.is_alive):
                self.living_population.append(person)
                if(person.infection != None):
                    self.logger.log_infection(person)
                    self.current_infected += 1
